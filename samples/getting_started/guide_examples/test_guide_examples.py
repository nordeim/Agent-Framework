...
def test_code_interpreter_helper_syntax():
    # Ensure the guide_examples directory is importable during test runtime.
    sys.path.insert(0, str(HERE))
    import importlib
    code_interpreter_helper = importlib.import_module('code_interpreter_helper')
...
async def test_multimodal_image_example():
    sys.path.insert(0, str(HERE))
    import importlib
    multimodal_image_example = importlib.import_module('multimodal_image_example')
