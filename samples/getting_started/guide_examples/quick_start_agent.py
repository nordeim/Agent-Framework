...
# Lightweight Field stub to keep annotations functional without pydantic
class Field:
...
def get_weather(
    ...
    This returns a short, deterministic human-readable string and is intended
    for example and test purposes only.
    """
